...
`goalmodel.config`, `goalmodel.prediction.rounds`, `goalmodel.prediction.predict`, `goalmodel.prediction.backtest_log`,
`goalmodel.evaluation.evaluate` e `goalmodel.models.baseline`, e non scrive da nessuna parte.
